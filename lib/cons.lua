...
-- line editor: echo, backspace, ctrl-d. runs entirely inside cons, so
-- every requester gets the same editing behavior regardless of who's
-- asking; nil replies mean eof on an empty line.
