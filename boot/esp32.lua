...
local function services()
	...
	-- The pointer is a right, not a file. task/dio.lua holds it and
	-- hands each app its own, the way the keyboard already worked:
	-- nothing outside this machine reads the panel, so a mount and a
	-- 9p hop bought a proc and no reader.
