 ...
 * changes. src/platform/microvm/lapic.c backs
 * CreateEvent/SetTimer/CheckEvent/WaitForEvent/Stall with the LAPIC
 * timer tick; ConIn is a permanently-empty stub, since microvm has no
 * keyboard.
 */
#ifndef MICROVM_EFI_H
#define MICROVM_EFI_H
