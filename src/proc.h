...
extern int luaopen_pcm_native(lua_State *L);	/* pcm_native.c: the volume */
...
extern int luaopen_los_platform_gps(lua_State *L);	/* drivers.c: T-Deck only, absent elsewhere */
